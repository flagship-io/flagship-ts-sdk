...
import { IHit, NewVisitor, primitive, VisitorCacheDTO, FlagDTO, IFSFlagMetadata, sdkInitialData, VisitorCacheStatus, FlagsStatus, SerializedFlagMetadata, CampaignDTO, VisitorVariations, EAIScore, VisitorProfile } from '../types.ts';

import { IVisitor } from './IVisitor.ts';
import { FSSdkStatus, SDK_INFO, VISITOR_ID_ERROR } from '../enum/index.ts';
import { hexToValue, logDebugSprintf, logError, uuidV4 } from '../utils/utils.ts';
...
import { GetFlagMetadataParam, GetFlagValueParam, IVisitorProfileCache, VisitorExposedParam, VisitorVariationState } from '../type.local.ts';
