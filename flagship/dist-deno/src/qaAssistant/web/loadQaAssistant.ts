...
import { FS_FORCED_VARIATIONS, FS_IS_QA_MODE_ENABLED, FS_VARIATIONS_FORCED_ALLOCATION, FS_VARIATIONS_FORCED_UNALLOCATION, QA_ASSISTANT_PROD_URL, TRUSTED_QA_ORIGINS } from '../../enum/FlagshipConstant.ts';
