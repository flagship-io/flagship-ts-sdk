...
import { BATCH_MAX_SIZE, BATCH_SENT_SUCCESS, DEFAULT_HIT_CACHE_TIME_MS, ALL_HITS_FLUSHED, FS_CONSENT, HEADER_APPLICATION_JSON, HEADER_CONTENT_TYPE, HitType, HIT_ADDED_IN_QUEUE, HIT_CACHE_VERSION, HIT_CACHE_SAVED, HIT_DATA_FLUSHED, HIT_EVENT_URL, PROCESS_CACHE_HIT, PROCESS_FLUSH_HIT, SDK_APP, SDK_INFO, HIT_CACHE_ERROR, PROCESS_CACHE, TRACKING_MANAGER, TRACKING_MANAGER_ERROR } from '../enum/index.ts'
