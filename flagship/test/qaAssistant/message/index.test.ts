...
describe('Test messages', () => {
  ...
  it('test sendVisitorAllocatedVariations', () => {
    ...
    expect(postMessageSpy).toBeCalledTimes(1)
    expect(postMessageSpy).toBeCalledWith({ name: MSG_NAME_TO_IFRAME.FsUpdateVisitorAllocatedVariation, value: visitorVariations }, '*')
  })
  ...
  it('test sendVisitorExposedVariations', () => {
    ...
    expect(postMessageSpy).toBeCalledTimes(1)
    expect(postMessageSpy).toBeCalledWith({ name: MSG_NAME_TO_IFRAME.FsVisitorExposedVariation, value: visitorExposedVariations }, '*')
  })
