...
describe('test DecisionApiConfig', () => {
  ...
  it('test config constructor', () => {
    ...
    const initialBucketing = { panic: true };

    const visitorCacheImplementation: IVisitorCacheImplementation = {

      cacheVisitor(_visitorId: string, _Data: VisitorCacheDTO):Promise<void> {
        throw new Error('Function not implemented.');
      },

      lookupVisitor(_visitorId: string): Promise<VisitorCacheDTO> {
        throw new Error('Function not implemented.');
      },

      flushVisitor(_visitorId: string): Promise<void> {
        throw new Error('Function not implemented.');
      }
    };
  ...
  it('Test initialBucketing', () => {
    const initialBucketingUpdate = { panic: false };
...
describe('Test SDK_LANGUAGE', () => {
  ...
  it('should be Deno', () => {
    ...
    globalThis.window = { Deno: expect.anything() } as any;
