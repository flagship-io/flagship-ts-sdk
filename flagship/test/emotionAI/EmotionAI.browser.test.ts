...
describe('EmotionAI', () => {
  ...
  const visitorDelegate = new VisitorDelegate({
    ...
    configManager,
    hasConsented: true,
    emotionAi: { init: jest.fn() } as unknown as EmotionAI
  });
  ...
  describe('fetchEAIScore', () => {
    ...
    it('should fetch EAI score from score route', async () => {
      const eAIScore:EAIScore = { eai: { eas: 'straightforward' } };
    ...
    it('should return score from cache if available', async () => {
      ...
      const eAIScore:EAIScore = { eai: { eas: 'straightforward-2' } };
  ...
  describe('test collectEAIData', () => {
    ...
    it('should collect data if eaiCollectEnabled is true', async () => {
      ...
      postAsyncSpy.mockResolvedValue({
        body: null,
        status: 200
      });
      ...
      const eAIScore:EAIScore = { eai: { eas: 'straightforward3' } };
  ...
  describe('reportVisitorEvent', () => {
    ...
    it('should trigger error when reporting visitor event', async () => {
      ...
      postAsyncSpy.mockRejectedValue({
        body: null,
        status: 400
      });
      expect(emotionAI.EAIScore).toBeUndefined();
