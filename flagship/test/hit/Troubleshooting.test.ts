...
describe('test hit type Monitoring', () => {
  ...
  it('test constructor', () => {
    ...
    const params:TroubleshootingType = {
      ...
      sdkConfigUsingCustomVisitorCache: true,
    ...
    const getCustomVariable = () => {
      return {
        ...
        'sdk.config.config.usingCustomVisitorCache': `${params.sdkConfigUsingCustomVisitorCache}`,
        'sdk.config.config.usingOnVisitorExposed': `${params.sdkConfigUsingOnVisitorExposed}`,
