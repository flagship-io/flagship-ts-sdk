  ...
  it('test constructor', () => {
    ...
    const getCustomVariable = () => {
      return {
        ...
        'sdk.config.hitDeduplicationTime': `${params.sdkConfigHitDeduplicationTime}`,
        'sdk.config.enableClientCache': `${params.sdkConfigEnableClientCache}`,
        'sdk.config.fetchNow': `${params.sdkConfigFetchNow}`,
        'sdk.config.initialBucketing': JSON.stringify(params.sdkConfigInitialBucketing),
        'sdk.config.trackingManager.strategy': `${CacheStrategy[params.sdkConfigTrackingManagerConfigStrategy as number]}`,
        'sdk.config.trackingManager.batchIntervals': `${params.sdkConfigTrackingManagerConfigBatchIntervals}`,
        'sdk.config.trackingManager.poolMaxSize': `${params.sdkConfigTrackingManagerConfigPoolMaxSize}`,
        ...
        'sdk.config.fetchFlagsBufferingTime': `${params.sdkConfigFetchFlagsBufferingTime}`,
