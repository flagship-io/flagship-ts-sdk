...
describe('test hit type Monitoring', () => {
  ...
  it('test constructor', () => {
    ...
    'type'|'createdAt'|'category'> = {
      ...
      sdkConfigTrackingManagerConfigStrategy: config.trackingMangerConfig.cacheStrategy,
      sdkConfigTrackingManagerConfigBatchIntervals: config.trackingMangerConfig.batchIntervals,
      sdkConfigTrackingManagerConfigPoolMaxSize: config.trackingMangerConfig.poolMaxSize,
