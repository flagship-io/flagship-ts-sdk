...
import { type HitAbstract, IEvent, type ITransaction, type IItem, type IPage, type IScreen } from '../hit/index'
...
import { ActivateConstructorParam, IActivate, ImportHitType } from '../type.local'
