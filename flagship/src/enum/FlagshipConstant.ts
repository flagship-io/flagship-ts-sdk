...
export const USER_EXPOSED_FLAG_ERROR = 'Visitor {0}, No Flags found for key {1}: User exposure wont be sent'
export const VISITOR_EXPOSED_VALUE_NOT_CALLED = 'Visitor {0}, you are exposing a flag without calling the method getValue before'
