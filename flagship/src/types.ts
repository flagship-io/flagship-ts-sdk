...
export type SubComponent = 'VISITOR-SEND-HIT'|'VISITOR-FETCH-CAMPAIGNS-ERROR'|'VISITOR-FETCH-CAMPAIGNS'|
...
'SEND-BATCH-HIT-ROUTE-RESPONSE-ERROR'|'SEND-BATCH-HIT-ROUTE-REQUEST'|'SEND-BATCH-HIT-ROUTE-RESPONSE'|'SEND-BATCH-HIT-ROUTE-RESPONSE-ERROR'|
'SEND-HIT-ROUTE-ERROR'|'SEND-ACTIVATE-HIT-ROUTE-RESPONSE'
