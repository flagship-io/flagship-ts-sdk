...
'GET-FLAG-METADATA-TYPE-WARNING'|'GET-FLAG-VALUE-TYPE-WARNING'|'VISITOR-EXPOSED-TYPE-WARNING'|'VISITOR-SEND-ACTIVATE'|
'GET-CAMPAIGNS-ROUTE-RESPONSE-ERROR'|'GET-CAMPAIGNS-ROUTE-RESPONSE'|'SDK-BUCKETING-FILE'|'SEND-ACTIVATE-HIT-ROUTE-ERROR'|
'SEND-BATCH-HIT-ROUTE-RESPONSE-ERROR'|'SEND-BATCH-HIT-ROUTE-RESPONSE-ERROR'|'SEND-HIT-ROUTE-ERROR'|'SDK-BUCKETING-FILE-ERROR'|'SDK-CONFIG'
