...
export enum TroubleshootingLabel {
  ...
  GET_CAMPAIGNS_ROUTE = 'GET_CAMPAIGNS_ROUTE',
...
export enum SdkMethod{
  FS_START = 'FS_START',
  FS_NEW_VISITOR = 'FS_NEW_VISITOR',
  FS_CLOSE = 'FS_CLOSE',
  VISITOR_SET_CONSENT = 'VISITOR_SET_CONSENT',
  VISITOR_SET_CONTEXT = 'VISITOR_SET_CONTEXT',
  VISITOR_UPDATE_CONTEXT = 'VISITOR_UPDATE_CONTEXT',
  VISITOR_CLEAR_CONTEXT = 'VISITOR_CLEAR_CONTEXT',
  VISITOR_FETCH_FLAGS = 'VISITOR_FETCH_FLAGS',
  VISITOR_GET_FLAG = 'VISITOR_GET_FLAG',
  VISITOR_GET_FLAGS = 'VISITOR_GET_FLAGS',
  VISITOR_SEND_HIT = 'VISITOR_SEND_HIT',
  VISITOR_AUTHENTICATE = 'VISITOR_AUTHENTICATE',
  VISITOR_UNAUTHENTICATE = 'VISITOR_UNAUTHENTICATE',
  FLAG_GET_VALUE = 'FLAG_GET_VALUE',
  FLAG_GET_METADATA = 'FLAG_GET_METADATA',
  FLAG_EXISTS = 'FLAG_EXISTS',
  FLAG_STATUS = 'FLAG_STATUS',
  FLAG_VISITOR_EXPOSED = 'FLAG_VISITOR_EXPOSED',
  FLAG_COLLECTION_GET = 'FLAG_COLLECTION_GET',
  FLAG_COLLECTION_EXPOSE_ALL = 'FLAG_COLLECTION_EXPOSE_ALL',
  FLAG_COLLECTION_GET_METADATA = 'FLAG_COLLECTION_GET_METADATA',
  FLAG_COLLECTION_TO_JSON = 'FLAG_COLLECTION_TO_JSON',
}
